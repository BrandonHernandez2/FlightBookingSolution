...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        long daysUntilFlight = Period.between(bookingDate, flightDate).getDays();
        System.out.println(bookingDate);
        System.out.println(flightDate);
        System.out.println("Days unitil the Flight: " + daysUntilFlight);
        System.out.println();
        ...
        System.out.println("Departure at: " + departureTime);
